...
export default function TechnikPage() {
  return (
    <AuthGuard>
      <style>{`
        .car-card { transition: border-color 0.2s, box-shadow 0.2s; }
        .car-card-tesla:hover  { border-color: rgba(59,130,246,0.85) !important; box-shadow: 0 0 32px rgba(59,130,246,0.22); }
        .car-card-troc:hover   { border-color: rgba(34,197,94,0.85)  !important; box-shadow: 0 0 32px rgba(34,197,94,0.22);  }
      `}</style>
      ...
      <div style={{ minHeight: '100vh', paddingBottom: '84px' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto', padding: '1.5rem 1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            {/* Tesla Model 3 */}
            <Link href="/technik/tesla" style={{ textDecoration: 'none', display: 'block' }}>
              <div className="car-card car-card-tesla" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem' }}>
                  ...
                  <div style={{
                    ...
                    fontSize: '2.2rem', filter: 'drop-shadow(0 0 12px rgba(59,130,246,0.4))',
                  }}>⚡</div>
                </div>

                <div style={{
                  display: 'inline-flex', alignItems: 'center', gap: '8px',
                  marginTop: '1.2rem', padding: '0.6rem 1rem', borderRadius: '100px',
                  background: 'rgba(59,130,246,0.1)', border: '1px solid rgba(59,130,246,0.25)',
                }}>
                  <span style={{ fontSize: '0.75rem', fontWeight: 700, color: '#60a5fa' }}>3D-Modell ansehen</span>
            ...
            {/* VW T-Roc */}
            <Link href="/technik/troc" style={{ textDecoration: 'none', display: 'block' }}>
              <div className="car-card car-card-troc" style={{
                position: 'relative', overflow: 'hidden',
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem' }}>
                  ...
                  <div style={{
                    ...
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: '2.2rem', filter: 'drop-shadow(0 0 12px rgba(34,197,94,0.4))',
                  }}>🚙</div>
                </div>
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '0.75rem', fontWeight: 700, color: '#4ade80' }}>3D-Modell ansehen</span>
